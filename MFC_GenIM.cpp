...
// MFC_GenIM.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CMFCGenIMApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CMFCGenIMApp

CMFCGenIMApp::CMFCGenIMApp()
{
...
// Единственный объект CMFCGenIMApp

CMFCGenIMApp theApp;


// Инициализация CMFCGenIMApp

BOOL CMFCGenIMApp::InitInstance()
{
